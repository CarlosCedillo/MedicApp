...
public class Helper {
    ...
    public static void sendEmail(Integer type, String userName, String doctorEmail, String activationCode)
        ...
        switch (type) {
            ...
            case 4:
                ...
                content = "Hola " + userName + "\n\n"
                        + "Este correo es para proporcionarle un código para el cambio de contraseña, favor de ingresarlo \n"
                        + "cuando la aplicación lo solicite:"
                        + "\n\n" + activationCode;
            break;
    ...
    public static void userMessage(String code) {
        ...
        switch (code) {
            ...
            // Reset passwor
            case "rstPssOk":
                userMessage = "Contraseña cambiada con éxito";
                type = JOptionPane.INFORMATION_MESSAGE;
            break;
            
            case "rstPssNo":
                userMessage = "No se cambio la contresañe";
                type = JOptionPane.ERROR_MESSAGE;
            break;
    ...
    public static void userMessage(String code, String string) {
        ...
        switch (code) {
            ...
            case "emlSchNo":
                userMessage = "El correo " + string + " no esta registrado";
                type = JOptionPane.ERROR_MESSAGE;
            break;

            // Singup
            case "usrCrtOk":
                userMessage = "Usuario " + string + " registrado con éxito";
                type = JOptionPane.INFORMATION_MESSAGE;
            break;
    ...
    public static void userMessage(String code, String username, String email) {
        ...
        switch (code) {
            ...
            // Reset passwor
            case "rstPss":
                userMessage = "Código para cambio de contraseña de " + username + " <br> enviado a " + email;
                type = JOptionPane.INFORMATION_MESSAGE;
            break;
    ...
    public static void consoleMessage(String code) {
        ...
        switch (code) {
            ...
            // Get Username
            case "getUsr":
                consoleMessage = "Message: Getting username";
            break;
    ...
    public static void consoleMessage(String code, String string) {
        ...
        switch (code) {
            ...
            // Reset password
            case "rstPss":
                consoleMessage = "User " + string + ": Resetting password";
            break;
            
            case "rstPssOk":
                consoleMessage = "User " + string + ": Password resetted succesfully";
            break;
            
            case "rstPssNo":
                consoleMessage = "User " + string + ": Password not reseted";
            break;
    ...
    public static void consoleMessage(String code, String username, String email) {
        ...
        switch (code) {
            ...
            // Reset passwor
            case "rstPss":
                consoleMessage = "User " + username + ": Code send to " + email;
            break;
